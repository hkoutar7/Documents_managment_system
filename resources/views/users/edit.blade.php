...
<div class="breadcrumb-header justify-content-between special ltr ltr-elem">
    <div class="my-auto">
        <div class="d-flex">
            ...
            <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ editer les détails de l'utilisateurs</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
    ...
    <div class="form_wrapper" style="justify-content: center; flex-grow: 0.4; border-radius: 11px; box-shadow: rgba(17, 17, 26, 0.1) 0px 1px 0px, rgba(17, 17, 26, 0.1) 0px 8px 24px, rgba(17, 17, 26, 0.1) 0px 16px 48px; margin-bottom: 80px;">
        <div class="form_container">
            ...
            <div class="row clearfix" style="justify-content: center;">
                <div style="width: 70% !important" class="ltr ltr-elem">
                    {!! Form::model($user, ['method' => 'PATCH', 'route' => ['users.update', $user->id]]) !!}

                    <div class="input_field"><span><i aria-hidden="true" class="fa fa-user"></i></span>
                        {!! Form::text('name', null, array('placeholder' => 'Entrez le nom du compte', 'class' => 'form-control')) !!}
                    </div>

                    <div class="input_field"> <span><i aria-hidden="true" class="fa fa-envelope"></i></span>
                        {!! Form::text('email', null, array('placeholder' => 'Entrez l\'email du compte', 'class' => 'form-control')) !!}
                    </div>

                    <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock"></i></span>
                        {!! Form::password('password', array('placeholder' => 'Entrez le mot de passe du compte', 'class' => 'form-control')) !!}
                    </div>

                    <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock"></i></span>
                        {!! Form::password('confirm-password', array('placeholder' => 'Confirmez le mot de passe du compte', 'class' => 'form-control')) !!}
                    </div>

                    <div class="input_field select_option">
                        <p>Choisissez le rôle de l'utilisateur parmi les rôles suivants</p>
