...
@section('page-header')
<!-- breadcrumb -->
<div class="breadcrumb-header justify-content-between special ltr">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Rôles</h4>&nbsp;&nbsp;
            <a href="{{ route('roles.index') }}" class="text-muted mt-1 tx-13 mr-2 mb-0" id="span-special">/ Liste des rôles</a>
            <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Éditer un rôle</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
            ...
            <div class="row clearfix" style="justify-content: center;">
                <div style="width: 70% !important">
                    ...
                    <div class="input_field">
                        ...
                        {!! Form::text('name', null, array('placeholder' => 'Entrez le nouveau nom du rôle', 'class' => 'form-control')) !!}
                    </div>
                    ...
                    <div class="input_field select_option">
                        ...
                        <label class="role-name">
                            ...
                            {{ Illuminate\Support\Str::ucfirst($value->name)  }}
                        </label>
                        @endforeach
                    </div>
